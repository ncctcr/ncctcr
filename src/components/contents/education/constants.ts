export const EDUCATION_DATA = [
  {
    ...
    rows: [
      ...
      { name: 'Date of birth', value: '19.12.1996' },
      { name: 'Educational Institution', value: 'Kherson State University' },
      { name: 'Degree', value: "Bachelor's" },
      { name: 'Date of issue', value: '30.06.2020' },
      { name: 'Date of graduation', value: '30.06.2020' },
      { name: 'Programme Subject Area', value: 'Software engineering' },
      { name: 'Educational Programme', value: 'Software engineering' },
      { name: 'Rector', value: 'Oleksandr Spivakovskiy' },
      { name: 'Name of awarding institution', value: 'Kherson State University' },
    ],
  },
  {
